const DIFFERENTIATORS = [
  {
    ...
    body: "No grid of provider logos we don't actually have access to, just Sana (via Pollinations) and LTX (via Pixazo), disclosed plainly.",
  },
  {
  ...
  },
  {
    ...
    body: "A failed generation refunds itself automatically. That is checked in code, not just claimed in an FAQ.",
  },
  {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 py-16">
      ...
      <p className="text-sm sm:text-base text-text-muted mt-5 leading-relaxed max-w-2xl">
        ...
        prompt box and one subscription. This version keeps that idea, the
        same sitemap, the same generation flow, and the same credit economy,
        but rebuilds the implementation from nothing, on real, free-tier
        providers instead of licensed access to Sora, Veo, and Runway.
      </p>
      ...
      <blockquote className="mt-14 border-l-2 border-accent pl-5 italic text-text-muted">
        ...
        access. It was to reproduce the product experience faithfully, and to
